try:
    ...
    class ExecVars:
        ...
        API_HASH = "44b857516a17a2d23979f927c003c874"
        API_ID = 7992241
        BOT_TOKEN = "2032136926:AAFdzMt1IrHSIPezOeuQOOCWE_CXfJgb8yM"
        BASE_URL_OF_BOT = "https://172.18.255.255"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001580179255]
        OWNER_ID = 1147258041
